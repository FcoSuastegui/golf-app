...
class ListTileNotificationCustom extends StatelessWidget {
  ...
  ListTileNotificationCustom({ 
    ...
    this.bottom = 0.0,
    this.boxshadow = true,
    this.color = CustomColors.iconColor
  });
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border.all(width: 0.3, color: boxshadow ? Colors.grey[200] : Colors.grey[800])
          ),
        ),
      )
    );
